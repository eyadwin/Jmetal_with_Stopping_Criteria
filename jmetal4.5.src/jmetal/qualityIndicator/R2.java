...
public class R2 {
  ...
  */
  ...
  R2(double [][] approximation,double [][] paretoFront) 
  {
    ...
    // STEP 1. Obtain the maximum and minimum values of the Pareto front
    maximumValue = utils_.getMaximumValues(paretoFront, paretoFront[0].length /*nObj_*/);
    minimumValue = utils_.getMinimumValues(paretoFront, paretoFront[0].length /*nObj_*/);

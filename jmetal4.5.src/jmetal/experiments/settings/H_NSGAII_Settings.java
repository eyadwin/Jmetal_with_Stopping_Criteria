...
import jmetal.metaheuristics.nsgaII.Hybrid_NSGAII;
 ...
 * @author UsEr
 */
public class H_NSGAII_Settings extends Settings {
     ...
     * Constructor
     */
    public H_NSGAII_Settings(String problem) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm = new Hybrid_NSGAII(problem_);

 ...
 * @author UsEr
 */
public class Stopping_NSGAII_Study extends Experiment {
...
//            algorithm[3] = new H_MOEAD_Settings(problemName).configure(parameters[3]);
            ...
            algorithm[0] = new NSGAII_Settings(problemName).updateSettings(algorithm[0], params1);
            algorithm[1] = new NSGAII_Settings(problemName).updateSettings(algorithm[1], params2);
...
//            algorithm[4] = new Harmony_NSGAII_Settings(problemName).updateSettings(algorithm[4], params);
    ...
    public static void main(String[] args) throws JMException, IOException {
        Stopping_NSGAII_Study exp = new Stopping_NSGAII_Study(); // exp = experiment

        exp.experimentName_ = "StoppingNSGAII";
...
//        exp.paretoFrontFile_ = new String[]{"ZDT4.pf","ZDT1.pf"};
        ...
        exp.experimentBaseDirectory_ = "000__Output\\000__Results_NSGA_II\\"+ exp.experimentName_;

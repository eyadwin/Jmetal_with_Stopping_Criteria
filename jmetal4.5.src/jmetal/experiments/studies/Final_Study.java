 ...
 * @author UsEr
 */
public class Final_Study extends Experiment {
...
//            parameters[3].put("crossoverProbability_", 0.7);
    ...
    public static void main(String[] args) throws JMException, IOException {
        Final_Study exp = new Final_Study(); // exp = experiment

        exp.experimentName_ = "FinalStudy";
        exp.algorithmNameList_ = new String[]{
            "NSGAII",  "MOEAD" , "hNSGAII", "hMOEAD"};
        exp.problemList_ = new String[]{
             "ZDT1","ZDT2", "ZDT3", "DTLZ1"};
        exp.paretoFrontFile_ = new String[]{
             "ZDT1.pf","ZDT2.pf", "ZDT3.pf", "DTLZ1.3D.pf"};
        ...
        problems = new String[]{ "ZDT1","ZDT2", "ZDT3", "DTLZ1",};

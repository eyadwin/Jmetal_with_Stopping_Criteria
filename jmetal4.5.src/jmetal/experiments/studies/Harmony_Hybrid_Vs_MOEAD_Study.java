 ...
 * @author UsEr
 */
public class Harmony_Hybrid_Vs_MOEAD_Study extends Experiment {
...
//            parameters[3].put("crossoverProbability_", 0.7);
            ...
            algorithm[1] = new H_MOEAD_Settings(problemName).configure(parameters[1]);
...
//            algorithm[3] = new H_MOEAD_Settings(problemName).configure(parameters[3]);
    ...
    public static void main(String[] args) throws JMException, IOException {
        Harmony_Hybrid_Vs_MOEAD_Study exp = new Harmony_Hybrid_Vs_MOEAD_Study(); // exp = experiment

        exp.experimentName_ = "HarmonyStudyFour";
        exp.algorithmNameList_ = new String[]{
            "HarmonyHybridMOEAD" , "HybridMOEAD"};
...
//            "UF1.pf","UF2.pf","UF3.pf","UF4.pf","UF5.pf","UF6.pf","UF7.pf","UF8.pf","UF9.pf","UF10.pf"};
            "DTLZ7.3D.pf","UF8.pf","UF9.pf","ZDT2.pf"};      

 ...
 * @author UsEr
 */
public class Stopping_Harmony_MOEAD_Study extends Experiment {
...
//            algorithm[4] = new Harmony_NSGAII_Settings(problemName).updateSettings(algorithm[4], params);
    ...
    public static void main(String[] args) throws JMException, IOException {
        Stopping_Harmony_MOEAD_Study exp = new Stopping_Harmony_MOEAD_Study(); // exp = experiment

        exp.experimentName_ = "StoppingHarmonyMOEAD";
...
//        exp.paretoFrontFile_ = new String[]{"ZDT4.pf","ZDT1.pf"};
        ...
        exp.experimentBaseDirectory_ = "000__Results_HMOEAD\\"+ exp.experimentName_;

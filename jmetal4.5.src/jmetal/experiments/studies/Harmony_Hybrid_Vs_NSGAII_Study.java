 ...
 * @author UsEr
 */
public class Harmony_Hybrid_Vs_NSGAII_Study extends Experiment {
...
//            parameters[3].put("crossoverProbability_", 0.7);
           ...
           algorithm[1] = new H_NSGAII_Settings(problemName).configure(parameters[1]);
...
//            algorithm[3] = new H_MOEAD_Settings(problemName).configure(parameters[3]);
    ...
    public static void main(String[] args) throws JMException, IOException {
        Harmony_Hybrid_Vs_NSGAII_Study exp = new Harmony_Hybrid_Vs_NSGAII_Study(); // exp = experiment

        exp.experimentName_ = "HarmonyStudyThree";
        exp.algorithmNameList_ = new String[]{
            "HarmonyHybridNSGAII" , "HybridNSGAII"};
...
//            "UF1.pf","UF2.pf","UF3.pf","UF4.pf","UF5.pf","UF6.pf","UF7.pf","UF8.pf","UF9.pf","UF10.pf"};
                    "DTLZ4.3D.pf","ZDT1.pf","ZDT6.pf","UF5.pf"};

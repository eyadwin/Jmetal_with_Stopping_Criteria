 ...
 * @author UsEr
 */
public class Harmony_Hybrid_MOEAD extends Algorithm {
     ...
     */
    public Harmony_Hybrid_MOEAD(Problem problem) {
        super(problem);
        ...
        do {
            ...
            for (int i = 0; i < populationSize_; i++) {
                ...
                while (bad) {
                    ...
                    if (isBetter(child, offspringPopulation.get(lasPos))) {
...
//                              System.out.println("00                       " + evaluations_ + "              " + S);
            ...
            Solution newHarmonySolution = null;

//            for (int i = 0; i < population.size(); i++) {
//                offspringPopulation.add(population.get(i));
//            }
            int i = 0;
            while (i < populationSize_) {

                HarmonyUnit hUnit = (HarmonyUnit) memoryConOperator.execute(population_);
                hUnit = (HarmonyUnit) randomConOperator.execute(hUnit);
                ...
                int lasPos = population_.size() - 1;

                population_ = sort(population_);
                if (isBetter(newHarmonySolution, population_.get(populationSize_ / 2))) {
